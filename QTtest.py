...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def all_close(self):
        ...
        self.ProcessRobot.client.write_registers(40010, [0, 0], unit=1)
        self.ProcessRobot.client.write_registers(40008, [0, 0], unit=1)
        self.ProcessRobot.client.write_registers(40006, [0, 0], unit=1)
    ...
    def open_alls(self):
        ...
        s = threading.Thread(target=self.Thread)
        s.start()
    ...
    def Thread(self): # data
        while True:
            ...
            if self.ProcessRobot.client.read_holding_registers(40005, 1, unit=1).registers == [2]:
                ...
                self.ProcessRobot.stop()
                self.ProcessRobot.client.write_registers(40004, [0, 0], unit=1)
            T1 = self.ProcessRobot.client.read_holding_registers(40001, 1, unit=1).registers[0]
            num = T1 + (self.ProcessRobot.client.read_holding_registers(40007, 1, unit=1).registers[0] * 8) -1
